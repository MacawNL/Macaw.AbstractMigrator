...
{
    public class SchemaMigrationExecutor<TDatabase> : IMigrateSchema<TDatabase> where TDatabase : class
    {
        private IRunMigrations<TDatabase> _runner;
        private readonly IEnumerable<IMigrationTask<TDatabase>> _tasks;
        ...
        internal IEnumerable<IMigrationTask<TDatabase>> Tasks
        {
            get { return _tasks; }
        }
        ...
        /// </summary>
        public IRunMigrations<TDatabase> Runner
        {
            get { return _runner; }
            set
            {
